...
class LevelPlayUtils {
  companion object {
    /**
     * Invokes a method on the given method channel from the UI thread. This method is used to
     * invoke Flutter methods from non-UI threads.
     *
                ...
                object : MethodChannel.Result {
                  ...
                  override fun notImplemented() {
                    try {
                      ...
                      Log.e(
                              IronSourceMediationPlugin.TAG,
                              "Critical Error: invokeMethod $methodName notImplemented "
                      )
                    }
                  }
                }
     ...
     */
    fun hashMapOfRewardedVideoPlacementAdInfo(
            placement: Placement,
            adInfo: AdInfo
    ): HashMap<String, Any> {
      return hashMapOf("placement" to placement.toMap(), "adInfo" to adInfo.toMap())
    }
     ...
     */
    fun hashMapOfIronSourceErrorAdInfo(
            error: IronSourceError,
            adInfo: AdInfo
    ): HashMap<String, Any> {
      return hashMapOf("error" to error.toMap(), "adInfo" to adInfo.toMap())
    }
     ...
     */
    fun hashMapOfIronSourceNativeAdAndAdInfo(
            nativeAd: LevelPlayNativeAd?,
            adInfo: AdInfo?
    ): HashMap<String, Any?> {
      return hashMapOf("nativeAd" to nativeAd?.toMap(), "adInfo" to adInfo?.toMap())
    }
     ...
     */
    fun hashMapOfIronSourceNativeAdAndError(
            nativeAd: LevelPlayNativeAd?,
            error: IronSourceError?
    ): HashMap<String, Any?> {
      return hashMapOf("nativeAd" to nativeAd?.toMap(), "error" to error?.toMap())
    }
